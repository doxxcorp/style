...
for group_name in sorted(group_lines.keys()):
    ...
    lines.append("")
    lines.append("| Icon | Name | Label | Color | Stats Ref | Source |")
    lines.append("|------|------|-------|-------|-----------|--------|")
    for rel, name, et, cat, label, color_badge, stats_badge, source in group_lines[group_name]:
        ...
        lines.append(f"| <img src=\"{rel}\" width=\"24\" height=\"24\"> | `{et_cat or name}` | {label} | {color_badge} | {stats_badge} | {src_short} |")
    lines.append("")
