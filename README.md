...
| 64px | 128px | 256px | 512px |
|:----:|:-----:|:-----:|:-----:|
| ![](logo-png/isotype-black/isotype-black-64.png) | ![](logo-png/isotype-black/isotype-black-128.png) | ![](logo-png/isotype-black/isotype-black-256.png) | ![](logo-png/isotype-black/isotype-black-512.png) |
...
| 180w | 256w | 512w |
|:----:|:----:|:----:|
| ![](logo-png/logotype-black/logotype-black-180w.png) | ![](logo-png/logotype-black/logotype-black-256w.png) | ![](logo-png/logotype-black/logotype-black-512w.png) |
...
| 256px | 512px |
|:-----:|:-----:|
| ![](logo-png/imagotype-black/imagotype-black-256.png) | ![](logo-png/imagotype-black/imagotype-black-512.png) |
...
|-------|------|-----|-----|------|---------|
| ![](https://img.shields.io/badge/-%20-14141E) | Dark Blue Grey | `#14141E` | 20, 20, 30 | 92, 83, 54, 78 | Primary background |
| ![](https://img.shields.io/badge/-%20-F7F7F7) | Signal White | `#F7F7F7` | 237, 237, 237 | 8, 6, 7, 0 | Primary foreground |
| ![](https://img.shields.io/badge/-%20-5BBDBA) | Neon Green | `#5BBDBA` | 91, 189, 186 | 70, 0, 34, 0 | CTAs, system indicators |
| ![](https://img.shields.io/badge/-%20-C82AD3) | Mexican Pink | `#C82AD3` | 200, 42, 211 | 47, 82, 0, 0 | Energy, identity, bold expression |

### 2.2 Neutral Support Colors

| Color | Name | HEX | RGB | Purpose |
|-------|------|-----|-----|---------|
| ![](https://img.shields.io/badge/-%20-9B9B9B) | Graphite Gray | `#9B9B9B` | 155, 155, 155 | Panels, cards, dividers |
| ![](https://img.shields.io/badge/-%20-D3D3D3) | Steel Gray | `#D3D3D3` | 211, 211, 211 | Borders, secondary text, placeholders |

### 2.3 Tertiary Color Palette (Mobile Activation)

| Color | HEX | RGB | Usage |
|-------|-----|-----|-------|
| ![](https://img.shields.io/badge/-%20-B9D730) | `#B9D730` | 185, 215, 48 | Hover/focus states |
| ![](https://img.shields.io/badge/-%20-F68D0B) | `#F68D0B` | 91, 189, 186 | Active states |
| ![](https://img.shields.io/badge/-%20-57B7ED) | `#57B7ED` | 87, 183, 237 | Selected items |
| ![](https://img.shields.io/badge/-%20-7949A7) | `#7949A7` | 121, 73, 167 | Toggle backgrounds |
| ![](https://img.shields.io/badge/-%20-F8D8A5) | `#F8D8A5` | 248, 216, 165 | Progress indicators |
| ![](https://img.shields.io/badge/-%20-AA87D1) | `#AA87D1` | 170, 135, 209 | Tab selection |
| ![](https://img.shields.io/badge/-%20-D92E29) | `#D92E29` | 217, 46, 41 | Error/destructive |
| ![](https://img.shields.io/badge/-%20-ABCDEA) | `#ABCDEA` | 171, 205, 234 | Info states |
| ![](https://img.shields.io/badge/-%20-4D4D5A) | `#4D4D5A` | 77, 77, 90 | Inactive/disabled |
| ![](https://img.shields.io/badge/-%20-F5C122) | `#F5C122` | 245, 193, 34 | Warning/caution |
...
|-------|------|-----|-------|-----|
| ![](https://img.shields.io/badge/-%20-14141F) | Dark | `#14141F` | `doxxDarkBackground` | `--bg-dark` |
...
| Color | Name | HEX | Swift | CSS | Usage |
|-------|------|-----|-------|-----|-------|
| ![](https://img.shields.io/badge/-%20-FFFFFF) | Primary | `#FFFFFF` | `doxxTextPrimary` | `--text-primary` | Headings, labels |
| ![](https://img.shields.io/badge/-%20-D1C7FF) | Secondary | `#D1C7FF` | `doxxTextSecondary` | `--text-secondary` | Body, links |
| ![](https://img.shields.io/badge/-%20-9A91C8) | Tertiary | `#9A91C8` | `doxxTextTertiary` | `--text-tertiary` | Captions, hints |

### Main Gradient

| Color | Name | HEX | Swift | Position |
|-------|------|-----|-------|----------|
| ![](https://img.shields.io/badge/-%20-667EEA) | Start | `#667EEA` | `doxxTileGradientStart` | Top-left |
| ![](https://img.shields.io/badge/-%20-764BA2) | End | `#764BA2` | `doxxTileGradientEnd` | Bottom-right |
...
|-------|------|-----|-------|-------|
| ![](https://img.shields.io/badge/-%20-FFFFFF) | Toolbar | `#FFFFFF` | `.white` | NOT accent colors |
...
| Color | Name | HEX | Swift | CSS | Usage |
|-------|------|-----|-------|-----|-------|
| ![](https://img.shields.io/badge/-%20-DB00DB) | Focus | `#DB00DB` | `doxxBorderMagenta` | `--border-focus` | Highlighted elements |
| ![](https://img.shields.io/badge/-%20-262626) | Subtle | `#262626` | `doxxBorderWhiteSubtle` | `--border-subtle` | Dividers |
...
|-------|------|----------|-----------|-------|
| ![](https://img.shields.io/badge/-%20-ff71ce) ![](https://img.shields.io/badge/-%20-01cdfe) | Pink/Cyan | `#ff71ce` | `#01cdfe` | Tunnel 1 |
| ![](https://img.shields.io/badge/-%20-05ffa1) ![](https://img.shields.io/badge/-%20-b967ff) | Green/Purple | `#05ffa1` | `#b967ff` | Tunnel 2 |
| ![](https://img.shields.io/badge/-%20-fffb96) ![](https://img.shields.io/badge/-%20-ff9e7a) | Yellow/Orange | `#fffb96` | `#ff9e7a` | Tunnel 3 |
| ![](https://img.shields.io/badge/-%20-01ffff) ![](https://img.shields.io/badge/-%20-ff1493) | Aqua/Pink | `#01ffff` | `#ff1493` | Tunnel 4 |

### Bandwidth Gauges

| Color | Name | HEX | CSS | Usage |
|-------|------|-----|-----|-------|
| ![](https://img.shields.io/badge/-%20-00ffaa) | Download | `#00ffaa` | `--gauge-download` | Download speed |
| ![](https://img.shields.io/badge/-%20-00ff00) | Upload | `#00ff00` | `--gauge-upload` | Upload speed |
...
|-------|------|-----|--------------|
| ![](https://img.shields.io/badge/-%20-1BC1BC) | Teal | `#1BC1BC` | < 15ms |
